...
class MarkDownFormat:
    ...
    def student_info(student: Student, evaluation: Grading, comment: str) -> str:
        final_grade = evaluation.grade() - evaluation.late_penalty()
        return f"""
...
"""
    ...
    def code_header() -> str:
        ...
        Your submitted code follows on the next pages. Search for comments with
        "FEEDBACK" to see any direct feedback I may have for you.
        """
